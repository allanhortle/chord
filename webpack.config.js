...
var SRC = './src/chord/client/client.js';
var DEST = './src/chord/public/';
var PORT = process.env.CHORD_PORT || '3000';
...
var production = Object.assign({}, development, {
    ...
    plugins: [
        ...
        new ExtractTextPlugin("chord.css")
    ],
    module: {
        loaders: [
            JS_LOADER,
